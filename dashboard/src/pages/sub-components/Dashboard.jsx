...
import {
  ...
  deleteSoftwareApplications,
  getAllSoftwareApplications,
  resetApplicationSlice } from "../../store/slices/applicationSlice";
...
const Dashboard = () => {
  ...
  const handleDeleteSoftwareApplication = (id) =>{
    setAppId(id);
    dispatch(deleteSoftwareApplications(id));
  };
                ...
                <Card>
                  ...
                  <CardContent>
                    <Table>
                      ...
                      <TableBody>
                        {
                          projects && projects.length > 0 ? (projects.map(element => {
                            return (
                              <TableRow className = "bg-accent" key={element}>
                                <TableCell>
                                  <div className="font-semibold">{element.title}</div>
                                </TableCell>
                                <TableCell className = "hidden md:table-cell">{element.state}</TableCell>
