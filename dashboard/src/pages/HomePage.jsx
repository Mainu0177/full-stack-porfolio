    ...
    return (
        ...
        <div className='flex min-h-screen w-full flex-col bg-muted/40'>
            ...
            <nav className='flex flex-col items-center gap-4 px-2 sm:py-5'>
                ...
                <Package className = "h-9 w-9 transition-all group-hover:scale-110" />
            ...
            <header className='sticky top-0 z-30 flex h-14 items-center gap-4 border-b bg-background px-4 sm:static sm:h-auto sm:border-0 sm:bg-transparent sm:px-6 max-[900px]:h-[100px]'>
                <Sheet>
                    <SheetTrigger asChild>
                        <Button size = "icon" className = "sm:hidden" variant = "outline">
                            <PanelLeft className='h-5 w-5' />
                            <span className='sr-only'>Toggle Menu</span>
                        </Button>
                    </SheetTrigger>
                    <SheetContent side = "left" className="sm:max-x-xs">
                        ...
                        >
                            ...
                            <div className='flex items-center gap-4 md:grow-0 sm:mt-5 sm:ml-16'>
