...
const Contact = () => {
  ...
  const handleSenderMessage = async (e) =>{
    e.preventDefault();
  ...
  return (
    <div className="overflow-x-hidden">
      ...
      <form onSubmit={handleSenderMessage} className="flex flex-col gap-6">
        ...
        <div className="flex justify-end">
          {
            !loading ? (<Button className = "w-full sm:w-52" type = "submit">SEND MESSAGE</Button>)
            :
